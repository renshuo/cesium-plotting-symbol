...
const funcs1 = ref([
  [
    ...
    {name: '弧面', func: () => prop.gm.create({obj: 'CircleArcArea', color: '#00FF00'}) },
    {name: '扇形', func: () => prop.gm.create({obj: 'SectorArea', color: '#00FF00'}) },
    ...
    {name: '钳击', func: () => prop.gm.create({obj: 'PincerAttack', color: '#00FF00'}) },
  ],
  [
  ...
  [
    ...
    {name: '角度测量', func: () => prop.gm.create({obj: 'AngleMeasure', color: '#00ff00'}) },
    {name: '三角测量', func: () => prop.gm.create({obj: 'TriangleMeasure', color: '#00ff00'}) },
    {name: '通视线', func: () => prop.gm.create({obj: 'SightLine', color: '#00ff00'}) },
  ],
  [
