...
export default {
  ...
  data () {
    return {
      ...
      funcs1: [
        [
          {name: '多边形', func: () => gx.create({obj: 'Polygon', color: '#00F'}) },
          {name: '矩形', func: () => gx.create({obj: 'Rectangle', color: '#00F'}) },
          {name: '单箭头', func: () => gx.create({obj: 'Arrow1', color: '#00F'}) },
          {name: '椭圆', func: () => gx.create({obj: 'Ellipse', color: '#00F'}) },
          {name: '圆', func: () => gx.create({obj: 'Circle', color: '#00F'}) },
        ],
        [
          {name: '直线', func: () => gx.create(new gx.Polyline({color: '#f00'})) },
          {name: 'bezier1', func: () => gx.create(new gx.Bezier1({color: '#f00'})) },
          {name: 'bezier2', func: () => gx.create(new gx.Bezier2({color: '#f00'})) },
          {name: 'bezierN', func: () => gx.create(new gx.BezierN({color: '#f00'})) },
          {name: '平滑线', func: () => gx.create(new gx.BezierSpline({color: '#f00'})) },
          {name: '圆弧线', func: () => gx.create(new gx.CircleArc({color: '#f00'})) },
        ],
        [
          {name: '点', func: () => gx.create(new gx.Point({color: '#0f0'})) },
          {name: '船', func: () => gx.create(new gx.Boat({color: '#0f0'})) },
          {name: '车', func: () => gx.create(new gx.Vehicle({color: '#0f0'})) },
          {name: '地面站', func: () => gx.create(new gx.Station({color: '#0f0'})) },
          {name: '卫星', func: () => gx.create(new gx.Satellite({color: '#0f0'})) },
        ],
        [
          {name: '图', func: () => gx.create(new gx.Image({color: '#ff0'})) },
          {name: '红旗', func: () => gx.create(new gx.RedFlag({color: '#ff0'})) },
        ],
        [
